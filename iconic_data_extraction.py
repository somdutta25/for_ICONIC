...
import sys
#get the pass string from argument.
...
EXTRACT_FILE_PATH = '/Users/somduttasanyal/iconic/landing'
...
SQLITE_DB_NAME = 'sqlite:///iconic_db.db'
#Name of the table where we want to load the dataset from dataframe
SQLITE_STG_TABLE_NAME = 'stg_iconic_user_data'
